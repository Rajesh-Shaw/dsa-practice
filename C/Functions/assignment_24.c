...
(TSRN)
5. Write a function to find the sum of first N terms of the series 11/1+2!/2+3!/3+4!/4+5!/
5... n!/n (TSRS)
...
/*
5. Write a function to find the sum of first N terms of the series 11/1+2!/2+3!/3+4!/4+5!/5... n!/n (TSRS)
*/